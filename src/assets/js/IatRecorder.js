...
const APPID = '7609151e'
const API_SECRET = 'ODZhMDZkMjFiMDNiOWJjZDY0OTBkMmFl'
const API_KEY = 'fde58e7f8fa6a0d4c31286394ea98e7c'
...
const IatRecorder = class  {
  ...
  //设置oneWordText
  setOneWordText({oneWordText} = {}) {
    this.onTextChange && this.onTextChange(oneWordText || '')
    oneWordText !== undefined && (this.oneWordText = oneWordText)
  }
  // 修改听写参数
  ...
  start() {
    this.recorderStart()
    this.setOneWordText({oneWordText: ''})
  }
  stop() {
    this.recorderStop()
  }
